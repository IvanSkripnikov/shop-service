...
var routes = []route{
	...
	newRoute(http.MethodGet, "/v1/users/get-active", controllers.GetActiveUsersListV1),
	...
	newRoute(http.MethodDelete, "/v1/loyalty/remove/([0-9]+)", controllers.RemoveLoyaltyV1),
